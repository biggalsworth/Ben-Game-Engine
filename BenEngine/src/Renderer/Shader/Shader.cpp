...
namespace Engine
{
    ...
    void Shader::Compile(const std::unordered_map<GLenum, std::string>& shaderSources)
    {
        ...
        CORE_ASSERT(shaderSources.size() <= 2, "Shader Array is not sufficiently sized for the number of shaders");
        ...
        for (auto& kv : shaderSources)
        {
            ...
            {
                // If false, the vertex shader did not compile successfully
    ...
    void Shader::UploadUniformMat4(const std::string& name, const glm::mat4& matrix)
    {
        ...
        // transpose = specifies whether to transpose the matrix as the values are loaded into the uniform
        // Transposing a matrix flips it over its diagonal; that is, it switches the row and column indices of the matrix.
        // [1 2]   [1 3 5]
        // [3 4] => [2 4 6] or in essence, the transpose of a matrix is found by interchanging its rows and columns.
        // [5 6]
